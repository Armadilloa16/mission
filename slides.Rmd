...
The MS group at FII brings together MS experise to provide the most comprehensive MS-based strategies for industry partners. This is based on the group's expertise in MS (particularly MALDI Imaging) research and the ability to adapt cutting-edge workflows utilising MS platforms to address research and industires requirements.  
...
We aim to instill a culture of collaboration, open communication and learning to ensure all members and affiliates have a sound scientific approach to their work. We achieve this by standardising the approach to every aspect of day-today work; from experimental design and good lab practice to analysis and reporting of data generated for both industry and research.
...
- **Collaboration:**We belive that a collaborative approach to addressing the needs of industry as well as research questions is key to our success, and we aim to lead by example on defining, implementing and achieving successful collaborations both internally and externally
