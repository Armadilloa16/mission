...
- Access to FII, and the FII accelerator grants
...
- Active pursuit of non-federal funding
    - Defence?
    - Agriculture?
    - Small business?
...
The MS group at FII brings together MS experise to provide the most comprehensive 
MS-based strategies for industry partners. This is based on the group's expertise
in MS (particularly MALDI Imaging) research and the ability to adapt cutting-edge
workflows utilising MS platforms to address research and industires requirements. *(Mark)*

The MS group at FII aims to be a centre of expertise in MS with a specific focus 
on MALDI imaging, that can perform research and provide services to industry at
the highest scientific standards of transparency and reproducability. *(Lyron)*



## Mission Statement

fiiMS provides mass spectrometry expertise and infrastructure to the academic 
and industrial sectors in South Australia. We set the benchmark for global best 
practice in the preparation, analysis and reporting of results obtained, with a 
focus on our core strength areas: imaging and profiling mass spectrometry. This 
ensures robust and reproducible analytical outcomes, which underpins both 
translational academic research and the provision of high-end analytical 
capacities to industrial partners. *(Johan)*


## Vision Statement

**Our Vision Statement:**
We aim to instill a culture of collaboration, open communication and learning to 
ensure all members and affiliates have a sound scientific approach to their work. 
We achieve this by standardising the approach to every aspect of day-today work; 
from experimental design and good lab practice to analysis and reporting of data 
generated for both industry and research.*(Mark)*

The MS group at FII will help foster a global scientific environment that values 
free trade of information and constructive critisicm by both setting an example 
through our own cultural environment (through collaborations) and our 
procedures, which will be shared publically. *(Lyron)*
...
- **Principle:** We value, adhere to and teach the scientific method with particular emphasis on  reproducibility and the fundamental philosophy of science -- ?avoiding thinking in absolute terms?. 
- **Collaboration:**We belive that a collaborative approach to addressing the needs
of industry as well as research questions is key to our success, and we aim to lead 
by example on defining, implementing and achieving successful collaborations both internally and externally
- **Innovation:** We aim to be leaders in MS-based techniques, driven by state-of-the art technology and scientific expertise 
